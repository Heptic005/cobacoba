...
class _TechnicianPageState extends State<TechnicianPage> {
  ...
  void _startListening() {
    _subscription = _serialService.getReaderStream().listen(
      (data) {
        // if (data.active) return; // Removed invalid check
        // Note: flutter_libserialport stream might return raw bytes generally,
        // but our service converts to String.
        setState(() {
          _logs.add(data);
          // Auto scroll
